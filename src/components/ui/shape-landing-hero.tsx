                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                            <a
                                href="#contact"
                                className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-white text-black font-medium text-sm transition-transform hover:scale-105"
                            >
                                Book a Strategy Call
                            </a>
                            <a
                                href="#how-we-work"
                                className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-white/[0.05] border border-white/[0.1] text-white font-medium text-sm transition-all hover:bg-white/[0.1] hover:scale-105"
                            >
                                See How We Work
                            </a>
                        </div>
